export const TEXT = {
  en: {
    ...
    noticeText: 'Unrealistic scores (100,000+) have been removed from the leaderboard. Anti-cheat is now active. Play fair!',
  ...
  id: {
    ...
    lbAllTime: 'Semua',
    supporters: 'Donatur',
    noticeText: 'Skor tidak wajar (100.000+) telah dihapus dari leaderboard. Sistem anti-cheat kini aktif. Mainlah dengan jujur!',
